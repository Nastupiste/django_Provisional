...
class Usuario(AbstractUser):
    ...
    saldo = models.DecimalField(default=0.00, max_digits=14, decimal_places=2, validators=[MinValueValidator(0)])
...
class Producto(models.Model):
    ...
    precio = models.DecimalField(max_digits=14, decimal_places=2, validators=[MinValueValidator(0)])
    vip = models.BooleanField(default=False)
...
class Compra(models.Model):
    ...
    unidades = models.PositiveIntegerField(validators=[MinValueValidator(0)])
    importe = models.DecimalField(max_digits=14, decimal_places=2, validators=[MinValueValidator(0)])
    iva = models.FloatField(default=1.21)

    def __str__(self):
        return "Usuario: +"+self.usuario.username+" :"+self.producto.nombre+", unidades: "+self.unidades
